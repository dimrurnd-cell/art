...
Всего 174 файла, ~28 МБ (почти все — бинарные: картинки, фактуры, шрифт). Права: файлы 644, папки 755.
...
174 файла по SFTP заливаются долго, часть может не докачаться. Надёжнее
...
find . -type f | wc -l    # 174 (после сборки атласа — больше)
du -sh .                  # ~28M
...
Код и данные кешируются 10 минут; картинки и шрифт — 7 дней, если
